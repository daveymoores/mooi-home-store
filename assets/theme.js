...
function o(e){for(var t=-1,n=e?e.length:0,i=[];++t<n;){var o=e[t];o&&i.push(o)}return i}function r(e){return m.isWrapped(e)?e=[].slice.call(e):m.isNode(e)&&(e=[e]),e}function s(e){var t=f.data(e,"velocity");return null===t?i:t}function a(e){return function(t){return Math.round(t*e)*(1/e)}}/* Bezier curve function generator. Copyright Gaetan Renaudeau. MIT License: http://en.wikipedia.org/wiki/MIT_License */
function l(e,n,i,o){function r(e,t){return 1-3*t+3*e}function s(e,t){return 3*t-6*e}function a(e){return 3*e}function l(e,t,n){return((r(t,n)*e+s(t,n))*e+a(t))*e}function u(e,t,n){return 3*r(t,n)*e*e+2*s(t,n)*e+a(t)}function c(t,n){for(var o=0;o<m;++o){var r=u(n,e,i);if(0===r)return n;n-=(l(n,e,i)-t)/r}return n}function p(){for(var t=0;t<b;++t)S[t]=l(t*x,e,i)}function f(t,n,o){var r,s,a=0;do{s=n+(o-n)/2,r=l(s,e,i)-t,r>0?o=s:n=s}while(Math.abs(r)>v&&++a<y);return s}function d(t){for(var n=0,o=1,r=b-1;o!=r&&S[o]<=t;++o)n+=x;--o;var s=(t-S[o])/(S[o+1]-S[o]),a=n+s*x,l=u(a,e,i);return l>=g?c(t,a):0==l?a:f(t,n,n+x)}function h(){T=!0,e==n&&i==o||p()}var m=4,g=.001,v=1e-7,y=10,b=11,x=1/(b-1),w="Float32Array"in t;if(4!==arguments.length)return!1;for(var C=0;C<4;++C)if("number"!=typeof arguments[C]||isNaN(arguments[C])||!isFinite(arguments[C]))return!1;e=Math.min(e,1),i=Math.min(i,1),e=Math.max(e,0),i=Math.max(i,0);var S=w?new Float32Array(b):new Array(b),T=!1,E=function(t){return T||h(),e===n&&i===o?t:0===t?0:1===t?1:l(d(t),n,o)};E.getControlPoints=function(){return[{x:e,y:n},{x:i,y:o}]};var k="generateBezier("+[e,n,i,o]+")";return E.toString=function(){return k},E}function u(e,t){var n=e;return m.isString(e)?b.Easings[e]||(n=!1):n=m.isArray(e)&&1===e.length?a.apply(null,e):m.isArray(e)&&2===e.length?x.apply(null,e.concat([t])):!(!m.isArray(e)||4!==e.length)&&l.apply(null,e),!1===n&&(n=b.Easings[b.defaults.easing]?b.defaults.easing:y),n}function c(e){if(e)for(var t=(new Date).getTime(),n=0,o=b.State.calls.length;n<o;n++)if(b.State.calls[n]){var r=b.State.calls[n],a=r[0],l=r[2],u=r[3],d=!!u;u||(u=b.State.calls[n][3]=t-16);for(var h=Math.min((t-u)/l.duration,1),g=0,v=a.length;g<v;g++){var y=a[g],x=y.element;if(s(x)){var C=!1;if(l.display!==i&&null!==l.display&&"none"!==l.display){if("flex"===l.display){var T=["-webkit-box","-moz-box","-ms-flexbox","-webkit-flex"];f.each(T,function(e,t){w.setPropertyValue(x,"display",t)})}w.setPropertyValue(x,"display",l.display)}l.visibility!==i&&"hidden"!==l.visibility&&w.setPropertyValue(x,"visibility",l.visibility);for(var E in y)if("element"!==E){var k,I=y[E],P=m.isString(I.easing)?b.Easings[I.easing]:I.easing;if(1===h)k=I.endValue;else if(k=I.startValue+(I.endValue-I.startValue)*P(h),!d&&k===I.currentValue)continue;if(I.currentValue=k,w.Hooks.registered[E]){var A=w.Hooks.getRoot(E),N=s(x).rootPropertyValueCache[A];N&&(I.rootPropertyValue=N)}var L=w.setPropertyValue(x,E,I.currentValue+(0===parseFloat(k)?"":I.unitType),I.rootPropertyValue,I.scrollData);w.Hooks.registered[E]&&(w.Normalizations.registered[A]?s(x).rootPropertyValueCache[A]=w.Normalizations.registered[A]("extract",null,L[1]):s(x).rootPropertyValueCache[A]=L[1]),"transform"===L[0]&&(C=!0)}l.mobileHA&&s(x).transformCache.translate3d===i&&(s(x).transformCache.translate3d="(0px, 0px, 0px)",C=!0),C&&w.flushTransformCache(x)}}l.display!==i&&"none"!==l.display&&(b.State.calls[n][2].display=!1),l.visibility!==i&&"hidden"!==l.visibility&&(b.State.calls[n][2].visibility=!1),l.progress&&l.progress.call(r[1],r[1],h,Math.max(0,u+l.duration-t),u),1===h&&p(n)}b.State.isTicking&&S(c)}function p(e,t){if(!b.State.calls[e])return!1;for(var n=b.State.calls[e][0],o=b.State.calls[e][1],r=b.State.calls[e][2],a=b.State.calls[e][4],l=!1,u=0,c=n.length;u<c;u++){var p=n[u].element;if(t||r.loop||("none"===r.display&&w.setPropertyValue(p,"display",r.display),"hidden"===r.visibility&&w.setPropertyValue(p,"visibility",r.visibility)),!0!==r.loop&&(f.queue(p)[1]===i||!/\.velocityQueueEntryFlag/i.test(f.queue(p)[1]))&&s(p)){s(p).isAnimating=!1,s(p).rootPropertyValueCache={};var d=!1;f.each(w.Lists.transforms3D,function(e,t){var n=/^scale/.test(t)?1:0,o=s(p).transformCache[t];s(p).transformCache[t]!==i&&new RegExp("^\\("+n+"[^.]").test(o)&&(d=!0,delete s(p).transformCache[t])}),r.mobileHA&&(d=!0,delete s(p).transformCache.translate3d),d&&w.flushTransformCache(p),w.Values.removeClass(p,"velocity-animating")}if(!t&&r.complete&&!r.loop&&u===c-1)try{r.complete.call(o,o)}catch(e){setTimeout(function(){throw e},1)}a&&!0!==r.loop&&a(o),!0!==r.loop||t||(f.each(s(p).tweensContainer,function(e,t){/^rotate/.test(e)&&360===parseFloat(t.endValue)&&(t.endValue=0,t.startValue=360)}),b(p,"reverse",{loop:!0,delay:r.delay})),!1!==r.queue&&f.dequeue(p,r.queue)}b.State.calls[e]=!1;for(var h=0,m=b.State.calls.length;h<m;h++)if(!1!==b.State.calls[h]){l=!0;break}!1===l&&(b.State.isTicking=!1,delete b.State.calls,b.State.calls=[])}var f,d=function(){if(n.documentMode)return n.documentMode;for(var e=7;e>4;e--){var t=n.createElement("div");if(t.innerHTML="\x3c!--[if IE "+e+"]><span></span><![endif]--\x3e",t.getElementsByTagName("span").length)return t=null,e}return i}(),h=function(){var e=0;return t.webkitRequestAnimationFrame||t.mozRequestAnimationFrame||function(t){var n,i=(new Date).getTime();/* Technique by Erik Moller. MIT license: https://gist.github.com/paulirish/1579671 */
...
(function() {
  ...
  theme.classes.QuickAdd = (function() {
    function QuickAdd(root) {
      ...
      _this.index = '';
      _this.variants = theme.quick_add_products[_this.id].variants;
    ...
    QuickAdd.prototype.variantSelected = function(variant) {
      ...
      price = theme.utils.formatMoney(variant.price);
  ...
  theme.classes.IndexBanner = (function() {
    function IndexBanner(root) {
      ...
      if (_this.bg.length === 0) {
        _this.bg = _this.root.find('.banner--placeholder');
      }
      _this.load();
    }
  ...
  theme.classes.ProductPage = (function() {
    function ProductPage(container1) {
      ...
      _this.variant_container = _this.container.find('.product-page--variants');
      _this.variant_listbox = _this.container.find('.product-page--variant-select');
    ...
    ProductPage.prototype.variantSelected = function(variant) {
      var _this, compare_price, price, product_sold_out;
      _this = this;
      product_sold_out = false;
    ...
    ProductPage.prototype.thumbNavigation = function() {
      ...
      return _this.thumbs.on('keypress click', function(event) {
        var clicked_id, clicked_media, current_media;
        if (theme.utils.a11yClick(event)) {
          current_media = _this.container.find('.product-page--media[data-active="true"] > *');
          current_media.trigger('pause-media');
          clicked_id = $(this).attr('data-id');
          clicked_media = _this.container.find(".product-page--media[data-id='" + clicked_id + "'] > *:not(.a11y--focus-trigger)");
          _this.updateVariantImage(clicked_id);
          if (theme.utils.mqs.current_window !== 'small') {
            clicked_media.trigger('play-media');
          }
    ...
    ProductPage.prototype.updateVariantImage = function(variant_id) {
      ...
      media_slide = _this.media_slider.find("[data-id='" + variant_id + "']").closest('.owl-item');
      return _this.media_slider.find('.owl-carousel').trigger('owl.jumpTo', media_slide.index());
    };
  ...
  jQuery(function($) {
    var $filter_select, MAIN, PAGE, digitalDownloads, fw_media_queries, isFirefox, stickyFooter;
